      ...
      <Navbar expand="lg">
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <Nav>
              <Nav.Link as ={NavLink} to ={"/home"}>EN <img src={Global} alt="language" title="language" /></Nav.Link>
              <Nav.Link as ={NavLink} to ={"/home"} ><Button className='btn1 btnn'>الدخول</Button ></Nav.Link>
              <Nav.Link as ={NavLink} to ={"/home"}><Button className=' btnn'>منطقة العميل</Button > </Nav.Link>
